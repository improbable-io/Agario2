...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.metrics.EngineLatency", 190102)]
...
{
    public const uint COMPONENT_ID = 190102;
    public EngineLatencyUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Metrics.EngineLatencyData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Metrics.EngineLatencyDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static EngineLatencyUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Metrics.EngineLatencyData>(proto.ComponentData, (int) COMPONENT_ID);
