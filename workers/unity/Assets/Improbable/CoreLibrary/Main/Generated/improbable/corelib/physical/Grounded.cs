...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.physical.Grounded", 190104)]
...
{
    public const uint COMPONENT_ID = 190104;
    public GroundedUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Physical.GroundedData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Physical.GroundedDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static GroundedUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Physical.GroundedData>(proto.ComponentData, (int) COMPONENT_ID);
