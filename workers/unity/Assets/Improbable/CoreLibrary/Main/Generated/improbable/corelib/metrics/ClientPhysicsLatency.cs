...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.metrics.ClientPhysicsLatency", 190100)]
...
{
    public const uint COMPONENT_ID = 190100;
    public ClientPhysicsLatencyUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Metrics.ClientPhysicsLatencyData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Metrics.ClientPhysicsLatencyDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static ClientPhysicsLatencyUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Metrics.ClientPhysicsLatencyData>(proto.ComponentData, (int) COMPONENT_ID);
