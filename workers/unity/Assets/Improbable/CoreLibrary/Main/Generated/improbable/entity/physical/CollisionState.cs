...
{
[ReaderInterface]
[CanonicalName("improbable.entity.physical.CollisionState", 190119)]
...
{
    public const uint COMPONENT_ID = 190119;
    public CollisionStateUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Entity.Physical.CollisionStateData proto)
        : base(entityId, statesToClear, Improbable.Entity.Physical.CollisionStateDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static CollisionStateUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Entity.Physical.CollisionStateData>(proto.ComponentData, (int) COMPONENT_ID);
