...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.metrics.ClientPhysicsLatencyReply", 190101)]
...
{
    public const uint COMPONENT_ID = 190101;
    public ClientPhysicsLatencyReplyUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Metrics.ClientPhysicsLatencyReplyData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Metrics.ClientPhysicsLatencyReplyDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static ClientPhysicsLatencyReplyUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Metrics.ClientPhysicsLatencyReplyData>(proto.ComponentData, (int) COMPONENT_ID);
