...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.metrics.EngineLatencyReply", 190103)]
...
{
    public const uint COMPONENT_ID = 190103;
    public EngineLatencyReplyUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Metrics.EngineLatencyReplyData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Metrics.EngineLatencyReplyDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static EngineLatencyReplyUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Metrics.EngineLatencyReplyData>(proto.ComponentData, (int) COMPONENT_ID);
