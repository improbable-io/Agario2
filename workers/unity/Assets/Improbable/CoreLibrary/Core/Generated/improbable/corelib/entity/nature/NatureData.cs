...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.entity.nature.NatureData", 190131)]
...
{
    public const uint COMPONENT_ID = 190131;
    public NatureDataUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Entity.Nature.NatureDataData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Entity.Nature.NatureDataDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static NatureDataUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Entity.Nature.NatureDataData>(proto.ComponentData, (int) COMPONENT_ID);
