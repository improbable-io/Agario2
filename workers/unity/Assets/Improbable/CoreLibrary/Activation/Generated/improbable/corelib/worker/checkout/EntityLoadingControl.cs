...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.worker.checkout.EntityLoadingControl", 190115)]
...
{
    public const uint COMPONENT_ID = 190115;
    public EntityLoadingControlUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Worker.Checkout.EntityLoadingControlData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Worker.Checkout.EntityLoadingControlDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static EntityLoadingControlUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Worker.Checkout.EntityLoadingControlData>(proto.ComponentData, (int) COMPONENT_ID);
