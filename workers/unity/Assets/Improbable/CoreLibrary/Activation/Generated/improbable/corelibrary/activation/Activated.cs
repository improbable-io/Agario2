...
{
[ReaderInterface]
[CanonicalName("improbable.corelibrary.activation.Activated", 190117)]
...
{
    public const uint COMPONENT_ID = 190117;
    public ActivatedUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelibrary.Activation.ActivatedData proto)
        : base(entityId, statesToClear, Improbable.Corelibrary.Activation.ActivatedDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static ActivatedUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelibrary.Activation.ActivatedData>(proto.ComponentData, (int) COMPONENT_ID);
