...
{
[ReaderInterface]
[CanonicalName("improbable.corelib.physical.Physicality", 190105)]
...
{
    public const uint COMPONENT_ID = 190105;
    public PhysicalityUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Corelib.Physical.PhysicalityData proto)
        : base(entityId, statesToClear, Improbable.Corelib.Physical.PhysicalityDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static PhysicalityUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Corelib.Physical.PhysicalityData>(proto.ComponentData, (int) COMPONENT_ID);
