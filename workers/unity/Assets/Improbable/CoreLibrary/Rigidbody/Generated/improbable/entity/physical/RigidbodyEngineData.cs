...
{
[ReaderInterface]
[CanonicalName("improbable.entity.physical.RigidbodyEngineData", 190123)]
public interface RigidbodyEngineDataReader : IEntityStateReader
{
    ...
    event System.Action<bool> IsSleepingUpdated;
}
...
public interface IRigidbodyEngineDataUpdater : IEntityStateUpdater
{
    ...
    IRigidbodyEngineDataUpdater IsSleeping(bool newValue);
}
...
public class RigidbodyEngineData : global::Improbable.Entity.State.StateBase<Improbable.Entity.Physical.RigidbodyEngineDataData, Schema.Improbable.Entity.Physical.RigidbodyEngineDataData>, RigidbodyEngineDataWriter, IRigidbodyEngineDataUpdater
{
    ...
    public bool IsSleeping { get { return Data.IsSleeping; } }
    ...
    private readonly global::System.Collections.Generic.List<System.Action<bool>> updatedCallbacksIsSleeping =
        new global::System.Collections.Generic.List<System.Action<bool>>();
    public event System.Action<bool> IsSleepingUpdated
    {
        add
        {
            updatedCallbacksIsSleeping.Add(value);
            value(Data.IsSleeping);
        }
        remove { updatedCallbacksIsSleeping.Remove(value); }
    }
    ...
    override protected void UnsubscribeEventHandlersInternal(object visualizer)
    {
        ...
        UnsubscribeEventHandler(visualizer, updatedCallbacksIsSleeping);
    }
    ...
    IRigidbodyEngineDataUpdater IRigidbodyEngineDataUpdater.IsSleeping(bool newValue)
    {
        if (Updater.Proto.IsSleepingSpecified || !IsSleeping.Equals(newValue))
        {
            Updater.Proto.IsSleeping = newValue;
        }
        return this;
    }
    ...
    override protected bool TriggerUpdatedEvents(Schema.Improbable.Entity.Physical.RigidbodyEngineDataData update, bool[] statesToClear)
    {
        ...
        bool updatedIsSleeping = update.IsSleepingSpecified;
        anythingUpdated |= updatedIsSleeping;
        if (updatedIsSleeping) TriggerCallbacks(updatedCallbacksIsSleeping, Data.IsSleeping);
...
{
    public const uint COMPONENT_ID = 190123;
    public RigidbodyEngineDataUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Entity.Physical.RigidbodyEngineDataData proto)
        : base(entityId, statesToClear, Improbable.Entity.Physical.RigidbodyEngineDataDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static RigidbodyEngineDataUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Entity.Physical.RigidbodyEngineDataData>(proto.ComponentData, (int) COMPONENT_ID);
