...
{
[ReaderInterface]
[CanonicalName("improbable.entity.physical.RigidbodyData", 190122)]
...
{
    public const uint COMPONENT_ID = 190122;
    public RigidbodyDataUpdate(global::Improbable.EntityId entityId, bool[] statesToClear, Schema.Improbable.Entity.Physical.RigidbodyDataData proto)
        : base(entityId, statesToClear, Improbable.Entity.Physical.RigidbodyDataDataHelper.Instance, proto, COMPONENT_ID) { }
    ...
    public static RigidbodyDataUpdate ExtractFrom(global::Improbable.Protocol.ComponentUpdate proto)
    {
        var protoState = ProtoBuf.Extensible.GetValue<Schema.Improbable.Entity.Physical.RigidbodyDataData>(proto.ComponentData, (int) COMPONENT_ID);
